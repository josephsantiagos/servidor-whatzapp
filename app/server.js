...
app.get("/mensagens", async (req, res) => {
  ...
  <head>
    ...
    <style>
      ...
      .top-bar { background: white; padding: 16px; border-radius: 8px; box-shadow: 0 1px 6px rgba(0,0,0,0.1); max-width: 1100px; margin: 0 auto 20px; }
      ...
      .btn { background: #25D366; color: white; padding: 10px 16px; border: none; border-radius: 6px; cursor: pointer; }
